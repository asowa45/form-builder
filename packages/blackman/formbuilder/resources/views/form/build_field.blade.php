                                    ...
                                    <div class="card-header" style="background-color: #fff; padding: 20px; border-bottom: 0;" id="item">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-1">
                                                ...
                                                <br>
                                                <input type="number" min="1" required class="form-control" value="{{old('order')}}" name="order" id="order">
                                            </div>
...
@push('end-script')
    ...
    <script>
        ...
        function hasAutoOption() {
            var opt_val = $("select#autocomplete>option:selected").val();
            if (opt_val == 1) {
        ...
        {{--function edit(key) {--}}
            ...
            {{--$.ajax({--}}
                ...
                {{--},--}}
                {{--complete:function(){--}}
                    {{--$.getScript("{{asset('js/jquery.repeater.min.js')}}")--}}
                    {{--$.getScript("{{asset('js/form-repeater.js')}}")--}}
                    {{--isChecked();--}}
                    {{--select_option();--}}
                    {{--hasAnOption();--}}
                    {{--hasAutoOption();--}}
